...
svn co https://github.com/immortalwrt/luci/trunk/contrib/package/lucihttp feeds/luci/contrib/package/lucihttp
# MOD Argon
...
sed -i 's/+luci-lib-ipkg //g' package/emortal/addition-trans-zh/Makefile
